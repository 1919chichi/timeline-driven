...
export default function UpcomingTaskItem({ task, openViewModal, openEditModal }: UpcomingTaskItemProps) {
  const infoTags = [task.accountId, task.accountInfo, task.coopInfo].filter(Boolean) as string[];
